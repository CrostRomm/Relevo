 ...
 * @version 1.0
 */
public class CorredorSeis extends Thread{
    /**
    ...
    public void run(){
        ...
        synchronized(camino){
            ...
            while (paso<=99) {
                ...
                Sincronizada.imprimirDos(camino);
            }
            camino.notify();
            if(camino.charAt(99)<='*'){
                System.out.println("GANADOOOOOOOOOOOOOOOOOR:  EQUIPO 2");
            }
        }
    }
    /*
    ...
    */
     ...
     * @param camino 
     */
    public CorredorSeis(int codigo, int equipo, StringBuffer camino) {
        this.codigo = codigo;
        this.equipo = equipo;
        this.camino = camino;
    }
